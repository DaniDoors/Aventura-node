...
while (Pagina !== 116) {
  console.log(MostraPagina());
  const opcio = TriarOpcio();
  Pagina = FindNextPage(opcio);
}

function MostraPagina() {
  let mostratext = libro[Pagina].texto + "\n\n";
  if (libro[Pagina].opcion1) {
    mostratext = mostratext + "1.-" + libro[Pagina].opcion1 + "\n";
  }
  if (libro[Pagina].opcion2) {
    mostratext = mostratext + "2.-" + libro[Pagina].opcion2 + "\n";
  }
  if (libro[Pagina].opcion3) {
    mostratext = mostratext + "3.-" + libro[Pagina].opcion3 + "\n";
  }
  if (libro[Pagina].opcion4) {
    mostratext = mostratext + "4.-" + libro[Pagina].opcion4 + "\n";
  }
  return mostratext;
}

function TriarOpcio() {
  if (libro[Pagina].opcion1 === "FIN") {
    return 5;
  }
...
function FindNextPage(opt) {
  if (opt === 1 || opt === "1") {
    return libro[Pagina].Pag1;
  }
  if (opt === 2 || opt === "2") {
    return libro[Pagina].Pag2;
  }
  if (opt === 3 || opt === "3") {
    return libro[Pagina].Pag3;
  }
  if (opt === 4 || opt === "4") {
    return libro[Pagina].Pag4;
  }
  if (opt === 5 || opt === "5") {
    return 116;
  }
