...
console.log(Pag001.texto);
console.log("");
console.log("EMPIEZA TU HISTORIA");
console.log("");
console.log(Pag002.texto);
console.log("");
console.log("1.-" + Pag002.opcion1);
console.log("");
console.log("2.-" + Pag002.opcion2);
console.log("");
let seguir = readlineSync.question("Que quieres hacer? ");
console.log("");
if (seguir === "1") {
  console.log(Pag003.texto);
  console.log("");
  console.log("                                FIN");
}
if (seguir === "2") {
